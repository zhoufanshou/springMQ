...
public class MyConsumer {
    private final Logger log = Logger.getLogger(MyConsumer.class);
    ...
    MyConsumer(String consumerGroup,String namesrvAddr){
            ...
            public ConsumeConcurrentlyStatus consumeMessage(List<MessageExt> msgs, ConsumeConcurrentlyContext context) {
                ...
                if (msg.getTopic().equals("MyTopic")) {
                    ...
                    if (msg.getTags() != null && msg.getTags().equals("MyTag")) {
                        // TODO 执行Tag的消费
                        log.info("接收到的内容："+new String(msg.getBody()));
                        System.out.println("接收到的内容："+new String(msg.getBody()));
                    }
                }
